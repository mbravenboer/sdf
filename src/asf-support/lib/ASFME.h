...
ATbool ASF_isOptLayoutAbsent(ASF_OptLayout arg);
ATbool ASF_isOptLayoutPresent(ASF_OptLayout arg);
...
ATbool ASF_isLayoutLexToCf(ASF_Layout arg);
...
ATbool ASF_isLexLayoutListEmpty(ASF_LexLayoutList arg);
ATbool ASF_isLexLayoutListSingle(ASF_LexLayoutList arg);
ATbool ASF_isLexLayoutListMany(ASF_LexLayoutList arg);
...
ATbool ASF_isTreeCast(ASF_Tree arg);
ATbool ASF_isTreeAmbiguityConstructor(ASF_Tree arg);
...
ATbool ASF_isLexCHARDefault(ASF_LexCHAR arg);
...
ATbool ASF_isASFConditionNegative(ASF_ASFCondition arg);
ATbool ASF_isASFConditionEquality(ASF_ASFCondition arg);
ATbool ASF_isASFConditionMatch(ASF_ASFCondition arg);
ATbool ASF_isASFConditionNoMatch(ASF_ASFCondition arg);
...
ATbool ASF_isASFConditionsDefault(ASF_ASFConditions arg);
...
ATbool ASF_isASFConditionListEmpty(ASF_ASFConditionList arg);
ATbool ASF_isASFConditionListSingle(ASF_ASFConditionList arg);
ATbool ASF_isASFConditionListMany(ASF_ASFConditionList arg);
...
ATbool ASF_isTreeAmbsEmpty(ASF_TreeAmbs arg);
ATbool ASF_isTreeAmbsSingle(ASF_TreeAmbs arg);
ATbool ASF_isTreeAmbsMany(ASF_TreeAmbs arg);
...
ATbool ASF_isLexASFBarEndAbsent(ASF_LexASFBarEnd arg);
ATbool ASF_isLexASFBarEndPresent(ASF_LexASFBarEnd arg);
ATbool ASF_isValidASFBarEnd(ASF_ASFBarEnd arg);
ATbool ASF_isASFBarEndLexToCf(ASF_ASFBarEnd arg);
...
ATbool ASF_isLexASFImpliesDefault(ASF_LexASFImplies arg);
...
ATbool ASF_isASFImpliesLexToCf(ASF_ASFImplies arg);
...
ATbool ASF_isASFConditionalEquationSimple(ASF_ASFConditionalEquation arg);
ATbool ASF_isASFConditionalEquationImplies(ASF_ASFConditionalEquation arg);
ATbool ASF_isASFConditionalEquationWhen(ASF_ASFConditionalEquation arg);
...
ATbool ASF_isASFEquationDefault(ASF_ASFEquation arg);
...
ATbool ASF_isStartASFModule(ASF_Start arg);
ATbool ASF_isStartASFSection(ASF_Start arg);
...
ATbool ASF_isASFModuleDefault(ASF_ASFModule arg);
...
ATbool ASF_isASFSectionEquations(ASF_ASFSection arg);
ATbool ASF_isASFSectionTests(ASF_ASFSection arg);
...
ATbool ASF_isASFSectionListEmpty(ASF_ASFSectionList arg);
ATbool ASF_isASFSectionListSingle(ASF_ASFSectionList arg);
ATbool ASF_isASFSectionListMany(ASF_ASFSectionList arg);
...
ATbool ASF_isASFConditionalEquationListEmpty(ASF_ASFConditionalEquationList arg);
ATbool ASF_isASFConditionalEquationListSingle(ASF_ASFConditionalEquationList arg);
ATbool ASF_isASFConditionalEquationListMany(ASF_ASFConditionalEquationList arg);
...
ATbool ASF_isASFTestEquationTestListEmpty(ASF_ASFTestEquationTestList arg);
ATbool ASF_isASFTestEquationTestListSingle(ASF_ASFTestEquationTestList arg);
ATbool ASF_isASFTestEquationTestListMany(ASF_ASFTestEquationTestList arg);
...
ATbool ASF_isLexASFTagIdOneChar(ASF_LexASFTagId arg);
ATbool ASF_isLexASFTagIdManyChars(ASF_LexASFTagId arg);
...
ATbool ASF_isASFTagIdLexToCf(ASF_ASFTagId arg);
...
ATbool ASF_isASFTagEmpty(ASF_ASFTag arg);
ATbool ASF_isASFTagNotEmpty(ASF_ASFTag arg);
...
ATbool ASF_isASFTestEquationSimple(ASF_ASFTestEquation arg);
ATbool ASF_isASFTestEquationImplies(ASF_ASFTestEquation arg);
ATbool ASF_isASFTestEquationWhen(ASF_ASFTestEquation arg);
...
ATbool ASF_isLexLayoutWhitespace(ASF_LexLayout arg);
...
ATbool ASF_isLexNumCharDigits(ASF_LexNumChar arg);
...
ATbool ASF_isNumCharLexToCf(ASF_NumChar arg);
...
ATbool ASF_isLexShortCharRegular(ASF_LexShortChar arg);
ATbool ASF_isLexShortCharEscaped(ASF_LexShortChar arg);
...
ATbool ASF_isShortCharLexToCf(ASF_ShortChar arg);
...
ATbool ASF_isCharacterNumeric(ASF_Character arg);
ATbool ASF_isCharacterShort(ASF_Character arg);
ATbool ASF_isCharacterTop(ASF_Character arg);
ATbool ASF_isCharacterEof(ASF_Character arg);
ATbool ASF_isCharacterBot(ASF_Character arg);
ATbool ASF_isCharacterLabelUnderscoreStart(ASF_Character arg);
