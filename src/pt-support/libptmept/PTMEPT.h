...
ATbool PTPT_isOptLayoutAbsent(PTPT_OptLayout arg);
ATbool PTPT_isOptLayoutPresent(PTPT_OptLayout arg);
...
ATbool PTPT_isLayoutLexToCf(PTPT_Layout arg);
...
ATbool PTPT_isLexLayoutListEmpty(PTPT_LexLayoutList arg);
ATbool PTPT_isLexLayoutListSingle(PTPT_LexLayoutList arg);
ATbool PTPT_isLexLayoutListMany(PTPT_LexLayoutList arg);
...
ATbool PTPT_isTreeAnnotated(PTPT_Tree arg);
ATbool PTPT_isTreeAppl(PTPT_Tree arg);
ATbool PTPT_isTreeCycle(PTPT_Tree arg);
ATbool PTPT_isTreeAmb(PTPT_Tree arg);
ATbool PTPT_isTreeChar(PTPT_Tree arg);
...
ATbool PTPT_isAttributesNoAttrs(PTPT_Attributes arg);
ATbool PTPT_isAttributesAttrs(PTPT_Attributes arg);
...
ATbool PTPT_isAttrsMany(PTPT_Attrs arg);
...
ATbool PTPT_isAttrAssoc(PTPT_Attr arg);
ATbool PTPT_isAttrTerm(PTPT_Attr arg);
ATbool PTPT_isAttrId(PTPT_Attr arg);
ATbool PTPT_isAttrBracket(PTPT_Attr arg);
ATbool PTPT_isAttrReject(PTPT_Attr arg);
ATbool PTPT_isAttrPrefer(PTPT_Attr arg);
ATbool PTPT_isAttrAvoid(PTPT_Attr arg);
...
ATbool PTPT_isAssociativityLeft(PTPT_Associativity arg);
ATbool PTPT_isAssociativityRight(PTPT_Associativity arg);
ATbool PTPT_isAssociativityAssoc(PTPT_Associativity arg);
ATbool PTPT_isAssociativityNonAssoc(PTPT_Associativity arg);
ATbool PTPT_isValidAttrList(PTPT_AttrList arg);
ATbool PTPT_isAttrListEmpty(PTPT_AttrList arg);
ATbool PTPT_isAttrListSingle(PTPT_AttrList arg);
ATbool PTPT_isAttrListMany(PTPT_AttrList arg);
...
ATbool PTPT_isParseTreeTop(PTPT_ParseTree arg);
...
ATbool PTPT_isSymbolEmpty(PTPT_Symbol arg);
ATbool PTPT_isSymbolLit(PTPT_Symbol arg);
ATbool PTPT_isSymbolCilit(PTPT_Symbol arg);
ATbool PTPT_isSymbolCf(PTPT_Symbol arg);
ATbool PTPT_isSymbolLex(PTPT_Symbol arg);
ATbool PTPT_isSymbolOpt(PTPT_Symbol arg);
ATbool PTPT_isSymbolAlt(PTPT_Symbol arg);
ATbool PTPT_isSymbolSeq(PTPT_Symbol arg);
ATbool PTPT_isSymbolTuple(PTPT_Symbol arg);
ATbool PTPT_isSymbolSort(PTPT_Symbol arg);
ATbool PTPT_isSymbolIter(PTPT_Symbol arg);
ATbool PTPT_isSymbolIterStar(PTPT_Symbol arg);
ATbool PTPT_isSymbolIterSep(PTPT_Symbol arg);
ATbool PTPT_isSymbolIterStarSep(PTPT_Symbol arg);
ATbool PTPT_isSymbolIterN(PTPT_Symbol arg);
ATbool PTPT_isSymbolIterSepN(PTPT_Symbol arg);
ATbool PTPT_isSymbolFunc(PTPT_Symbol arg);
ATbool PTPT_isSymbolVarsym(PTPT_Symbol arg);
ATbool PTPT_isSymbolLayout(PTPT_Symbol arg);
ATbool PTPT_isSymbolCharClass(PTPT_Symbol arg);
ATbool PTPT_isSymbolStrategy(PTPT_Symbol arg);
ATbool PTPT_isSymbolParameterizedSort(PTPT_Symbol arg);
...
ATbool PTPT_isSymbolsList(PTPT_Symbols arg);
...
ATbool PTPT_isCharRangesList(PTPT_CharRanges arg);
...
ATbool PTPT_isCharRangeCharacter(PTPT_CharRange arg);
ATbool PTPT_isCharRangeRange(PTPT_CharRange arg);
...
ATbool PTPT_isStartSymbol(PTPT_Start arg);
ATbool PTPT_isStartTree(PTPT_Start arg);
ATbool PTPT_isStartATerm(PTPT_Start arg);
ATbool PTPT_isStartIntCon(PTPT_Start arg);
ATbool PTPT_isStartRealCon(PTPT_Start arg);
...
ATbool PTPT_isSymbolListEmpty(PTPT_SymbolList arg);
ATbool PTPT_isSymbolListSingle(PTPT_SymbolList arg);
ATbool PTPT_isSymbolListMany(PTPT_SymbolList arg);
...
ATbool PTPT_isCharRangeListEmpty(PTPT_CharRangeList arg);
ATbool PTPT_isCharRangeListSingle(PTPT_CharRangeList arg);
ATbool PTPT_isCharRangeListMany(PTPT_CharRangeList arg);
...
ATbool PTPT_isArgsList(PTPT_Args arg);
...
ATbool PTPT_isProductionDefault(PTPT_Production arg);
ATbool PTPT_isProductionList(PTPT_Production arg);
...
ATbool PTPT_isTreeListEmpty(PTPT_TreeList arg);
ATbool PTPT_isTreeListSingle(PTPT_TreeList arg);
ATbool PTPT_isTreeListMany(PTPT_TreeList arg);
...
ATbool PTPT_isAFunQuoted(PTPT_AFun arg);
ATbool PTPT_isAFunUnquoted(PTPT_AFun arg);
...
ATbool PTPT_isATermInt(PTPT_ATerm arg);
ATbool PTPT_isATermReal(PTPT_ATerm arg);
ATbool PTPT_isATermFun(PTPT_ATerm arg);
ATbool PTPT_isATermAppl(PTPT_ATerm arg);
ATbool PTPT_isATermPlaceholder(PTPT_ATerm arg);
ATbool PTPT_isATermList(PTPT_ATerm arg);
ATbool PTPT_isATermAnnotated(PTPT_ATerm arg);
...
ATbool PTPT_isAnnotationDefault(PTPT_Annotation arg);
...
ATbool PTPT_isATermArgsEmpty(PTPT_ATermArgs arg);
ATbool PTPT_isATermArgsSingle(PTPT_ATermArgs arg);
ATbool PTPT_isATermArgsMany(PTPT_ATermArgs arg);
...
ATbool PTPT_isATermElemsEmpty(PTPT_ATermElems arg);
ATbool PTPT_isATermElemsSingle(PTPT_ATermElems arg);
ATbool PTPT_isATermElemsMany(PTPT_ATermElems arg);
...
ATbool PTPT_isATermAnnosEmpty(PTPT_ATermAnnos arg);
ATbool PTPT_isATermAnnosSingle(PTPT_ATermAnnos arg);
ATbool PTPT_isATermAnnosMany(PTPT_ATermAnnos arg);
...
ATbool PTPT_isIntConNatural(PTPT_IntCon arg);
ATbool PTPT_isIntConPositive(PTPT_IntCon arg);
ATbool PTPT_isIntConNegative(PTPT_IntCon arg);
...
ATbool PTPT_isOptExpPresent(PTPT_OptExp arg);
ATbool PTPT_isOptExpAbsent(PTPT_OptExp arg);
...
ATbool PTPT_isRealConRealCon(PTPT_RealCon arg);
...
ATbool PTPT_isLexStrCharNewline(PTPT_LexStrChar arg);
ATbool PTPT_isLexStrCharTab(PTPT_LexStrChar arg);
ATbool PTPT_isLexStrCharQuote(PTPT_LexStrChar arg);
ATbool PTPT_isLexStrCharBackslash(PTPT_LexStrChar arg);
ATbool PTPT_isLexStrCharDecimal(PTPT_LexStrChar arg);
ATbool PTPT_isLexStrCharNormal(PTPT_LexStrChar arg);
...
ATbool PTPT_isStrCharLexToCf(PTPT_StrChar arg);
...
ATbool PTPT_isLexStrConDefault(PTPT_LexStrCon arg);
...
ATbool PTPT_isStrConLexToCf(PTPT_StrCon arg);
...
ATbool PTPT_isLexStrCharCharsEmpty(PTPT_LexStrCharChars arg);
ATbool PTPT_isLexStrCharCharsSingle(PTPT_LexStrCharChars arg);
ATbool PTPT_isLexStrCharCharsMany(PTPT_LexStrCharChars arg);
...
ATbool PTPT_isLexNatConDigits(PTPT_LexNatCon arg);
...
ATbool PTPT_isNatConLexToCf(PTPT_NatCon arg);
...
ATbool PTPT_isLexIdConDefault(PTPT_LexIdCon arg);
...
ATbool PTPT_isIdConLexToCf(PTPT_IdCon arg);
...
ATbool PTPT_isLexLayoutWhitespace(PTPT_LexLayout arg);
